...
|  | Сейчас в курсе |
| --- | --- |
| 📚 Программа | **32 раздела · 151 урок · 585 заданий · 32 экзамена** |
| 🧠 Практика | Извлечение из памяти, интервалы 1/3/7/14/30, смешанные серии и исправление ошибок |
| 🛠️ Проекты | **15 инструментов** от открытки до менеджера задач |
...
app/
  ...
  advanced_practice.py    # 108 уникальных тематических кодовых заданий
  learning_design.py      # метаданные, интервалы и curriculum-linter
  projects.py             # 15 проектов и их исполняемые спецификации
