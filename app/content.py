...
LESSONS = [
    ...
    lesson(
        ...
        [
            ...
            code(
                "if-code",
                "Дано `temperature = 22`. Если температура не меньше 25, выведи «Надень шорты», иначе — «Возьми куртку».",
                "temperature = 22\n# напиши условие и выведи подходящую одежду\n",
                [{"kind": "stdout", "expected": "Возьми куртку"}],
                "22 меньше 25, поэтому выполняется ветка else и выводится «Возьми куртку».",
                "Сравни temperature с 25 через >=. В if выведи «Надень шорты», в else — «Возьми куртку».",
            ),
        ],
    ),
    lesson(
        ...
        [
            ...
            code(
                ...
                "range(1, 6) даёт числа от 1 до 5: верхняя граница не включается.",
                "В теле цикла вызови print(number).",
            ),
        ],
    ),
    lesson(
        ...
        [
            ...
            code(
                "while-code",
                "Дано `start = 5`. Выведи обратный отсчёт до 1, каждое число с новой строки, затем выведи «Пуск!».",
                "start = 5\nwhile start > 0:\n    # выведи start и уменьши его\n# выведи «Пуск!»\n",
                [{"kind": "stdout", "expected": "5\n4\n3\n2\n1\nПуск!"}],
                "while работает, пока start больше нуля: после каждого вывода уменьши start на 1, а затем выведи «Пуск!».",
                "В цикле напиши print(start) и start -= 1. После цикла — print('Пуск!').",
            ),
        ],
    ),
    lesson(
